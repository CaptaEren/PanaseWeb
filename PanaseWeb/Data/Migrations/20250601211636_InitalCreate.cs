        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TherapistNotes = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedWithTherapist = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientJournals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientJournals_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlogPosts_Psychologists_PsychologistId",
                        column: x => x.PsychologistId,
                        principalTable: "Psychologists",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resources_Psychologists_PsychologistId",
                        column: x => x.PsychologistId,
                        principalTable: "Psychologists",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiagnosisCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    TreatmentGoals = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TherapyNotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TherapyNotes_Psychologists_PsychologistId",
                        column: x => x.PsychologistId,
                        principalTable: "Psychologists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoodAssessment = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    HomeworkAssigned = table.Column<bool>(type: "bit", nullable: false),
                    PsychologistId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPosts_PsychologistId",
                table: "BlogPosts",
                column: "PsychologistId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientJournals_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Psychologists_Specialty",
                table: "Psychologists",
                column: "Specialty");

            migrationBuilder.CreateIndex(
                name: "IX_Resources_PsychologistId",
                table: "Resources",
                column: "PsychologistId");

            migrationBuilder.CreateIndex(
                name: "IX_TherapyNotes_PsychologistId",
                table: "TherapyNotes",
                column: "PsychologistId");

            migrationBuilder.CreateIndex(
                name: "IX_TherapyNotes_UserId",
                table: "TherapyNotes",
                column: "UserId");
